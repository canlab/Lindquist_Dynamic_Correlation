...
static emlrtRSInfo k_emlrtRSI = { 19, "epsilonToY",
  "/Users/xuyuting/Dropbox/YutingMartin/20160518 toolboxes/DCC2/epsilonToY.m" };

static emlrtRTEInfo i_emlrtRTEI = { 1, 18, "epsilonToY",
  "/Users/xuyuting/Dropbox/YutingMartin/20160518 toolboxes/DCC2/epsilonToY.m" };

static emlrtBCInfo y_emlrtBCI = { -1, -1, 19, 25, "epsilon", "epsilonToY",
  "/Users/xuyuting/Dropbox/YutingMartin/20160518 toolboxes/DCC2/epsilonToY.m", 0
};

static emlrtBCInfo ab_emlrtBCI = { -1, -1, 19, 7, "Y", "epsilonToY",
  "/Users/xuyuting/Dropbox/YutingMartin/20160518 toolboxes/DCC2/epsilonToY.m", 0
};

static emlrtBCInfo bb_emlrtBCI = { -1, -1, 19, 11, "Y", "epsilonToY",
  "/Users/xuyuting/Dropbox/YutingMartin/20160518 toolboxes/DCC2/epsilonToY.m", 0
};
...
static emlrtBCInfo cb_emlrtBCI = { -1, -1, 24, 34, "epsilon", "epsilonToY",
  "/Users/xuyuting/Dropbox/YutingMartin/20160518 toolboxes/DCC2/epsilonToY.m", 0
};

static emlrtBCInfo db_emlrtBCI = { -1, -1, 24, 36, "epsilon", "epsilonToY",
  "/Users/xuyuting/Dropbox/YutingMartin/20160518 toolboxes/DCC2/epsilonToY.m", 0
};

static emlrtBCInfo eb_emlrtBCI = { -1, -1, 24, 47, "epsilon", "epsilonToY",
  "/Users/xuyuting/Dropbox/YutingMartin/20160518 toolboxes/DCC2/epsilonToY.m", 0
};

static emlrtBCInfo fb_emlrtBCI = { -1, -1, 24, 49, "epsilon", "epsilonToY",
  "/Users/xuyuting/Dropbox/YutingMartin/20160518 toolboxes/DCC2/epsilonToY.m", 0
};

static emlrtBCInfo gb_emlrtBCI = { -1, -1, 24, 15, "Y", "epsilonToY",
  "/Users/xuyuting/Dropbox/YutingMartin/20160518 toolboxes/DCC2/epsilonToY.m", 0
};

static emlrtBCInfo hb_emlrtBCI = { -1, -1, 24, 21, "Y", "epsilonToY",
  "/Users/xuyuting/Dropbox/YutingMartin/20160518 toolboxes/DCC2/epsilonToY.m", 0
};
                ...
                emxArray_real_T *Y)
{
  ...
  while (t - 1 <= epsilon->size[0] - 1) {
    if (1 > K) {
      ...
      i1 = Y->size[0];
      if (!(K <= i1)) {
        emlrtDynamicBoundsCheckR2012b(K, 1, i1, (emlrtBCInfo *)&ab_emlrtBCI, sp);
      }
    ...
    if (!((loop_ub >= 1) && (loop_ub <= i1))) {
      emlrtDynamicBoundsCheckR2012b(loop_ub, 1, i1, (emlrtBCInfo *)&bb_emlrtBCI,
        sp);
    }
    ...
    i1 = epsilon->size[0];
    if (!((t >= 1) && (t <= i1))) {
      emlrtDynamicBoundsCheckR2012b(t, 1, i1, (emlrtBCInfo *)&y_emlrtBCI, sp);
    }
