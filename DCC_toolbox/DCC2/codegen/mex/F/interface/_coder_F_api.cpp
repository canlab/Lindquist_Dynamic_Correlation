 ...
 * _coder_F_api.cpp
 *
 * Code generation for function '_coder_F_api'
 *
 */
...
static emlrtRTEInfo l_emlrtRTEI = { 1, 1, "_coder_F_api", "" };
  ...
  static const mxArray *emlrt_marshallOut(const real_T u[2])
{
  ...
  emlrtSetDimensions((mxArray *)m1, *(int32_T (*)[2])&iv12[0], 2);
  emlrtAssign(&y, m1);
  return y;
}
...
void F_api(const mxArray * const prhs[3], const mxArray *plhs[1])
{
  real_T (*para_new)[2];
  emxArray_real_T *Y0;
  ...
  para_new = (real_T (*)[2])mxMalloc(sizeof(real_T [2]));
  emlrtHeapReferenceStackEnterFcnR2012b(&st);
  emxInit_real_T(&st, &Y0, 2, &l_emlrtRTEI, true);
  emxInit_real_T(&st, &vecS0, 2, &l_emlrtRTEI, true);
  ...
  F(&st, *para, Y0, vecS0, *para_new);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*para_new);
...
/* End of code generation (_coder_F_api.cpp) */
